...
# https://www.hackster.io/deligence-technologies/person-counting-system-using-opencv-and-python-faf14f
...
while True:
    ...
    for c in cnts:
        ...
        cv2.line(frame, (int(width / 2), 0), (width, 450), (250, 0, 1), 2) #blue line
        cv2.line(frame, (int(width / 2) - 50, 0), (width - 50, 450), (0, 0, 255), 2)#red line


        rectagleCenterPont = (int((x + x + w) / 2), int((y + y + h) /2))
